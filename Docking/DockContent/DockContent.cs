...
namespace WinDocking.Docking
{
    public class DockContent : Form, IDockContent
    {
        ...
        /// 显示默认视图
        /// </summary>
        /// <param name="panel">停靠面板</param>
        public void ShowView(DockPanel panel)
        {
            this.Show(panel, this.DefaultDockState);
        }
        /// <summary>
        /// 重新显示视图视图
        /// </summary>
        /// <param name="state">停靠状态</param>
        public void ShowView(DockState  state)
        {
            this.Show(this.DockPanel, state);
        }
        ...
        /// 设置窗体主题风格
        /// </summary>
        public virtual void SetThemeStyle()
        {
        }
